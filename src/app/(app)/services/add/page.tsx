    ...
    <div style={{ maxWidth: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <Link href="/services" style={{ color: 'var(--text2)', textDecoration: 'none', fontSize: 20, lineHeight: 1 }}>←</Link>
          <div>
            <h1 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-.02em' }}>Add New Service</h1>
            <p style={{ color: 'var(--text2)', fontSize: 13, marginTop: 2 }}>Fill in the details below</p>
          </div>
        </div>
          ...
          <Section title="🗂️ Basic Information">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              <Field label="Provider / Vendor">
                <input value={form.vendor} onChange={e=>upd('vendor',e.target.value)} placeholder="GoDaddy, AWS, Microsoft…" />
              </Field>
